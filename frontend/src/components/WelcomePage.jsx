    ...
    <div className="welcome-page">
      ...
      <div className="quick-access">
        <div className="quick-item" onClick={() => handleQuickAccess("emergency")}>
          <span className="quick-icon"><img src="/alert_3329142.png" alt="" className="emoji_home" /></span>
        ...
        <div className="quick-item" onClick={() => handleQuickAccess("screening")}>
          <span className="quick-icon"><img src="/stethoscope_2002576.png" alt="" className="emoji_home" /></span>
        ...
        <div className="quick-item" onClick={() => handleQuickAccess("consult")}>
          <span className="quick-icon"><img src="/doctor_3467875.png" alt="" className="emoji_home" /></span>
        ...
        <div className="quick-item" onClick={() => handleQuickAccess("pharmacy")}>
          <span className="quick-icon"><img src="/capsule_2008183.png" alt="" className="emoji_home" /></span>
