...
import AdminDiseaseAnalytics from './AdminDiseaseAnalytics.jsx'
...
export default function AdminDashboard() {
  ...
  const statsData = [
    {
      icon: "/toppng.com-icons-logos-emojis-user-icon-png-transparent-2400x2305.png",
      number: "4,569",
      label: "Patient",
      type: "patient",
    },
    {
      icon: "/note_4371132.png",
      number: "23,009",
      label: "Encounters",
      type: "encounters",
    },
  ...
  const navItems = [
    { icon: "/bar_14968536.png", label: "Dashboard", active: currentView === "dashboard", view: "dashboard" },
    { icon: "/schedule_3174027.png", label: "Appointments", active: currentView === "calendar", view: "calendar" },
    { icon: "/couple_547629.png", label: "Patients", active: currentView === "patients", view: "patients" },
    { icon: "/doctor_3467875.png", label: "Doctors", view: "doctor" },
    { icon: "⭐", label: "Features" },
    { icon: "/analytics_2030158.png", label: "Forms, Tables & Charts", view: "analytics" },
    { icon: "🧩", label: "Apps & Widgets" },
    { icon: "/lock.png", label: "Authentication" },
    { icon: "📦", label: "Miscellaneous", active: currentView === "survey", view: "survey"},
  ]
    ...
    <div className="admin-dashboard">
      ...
      <aside className={`admin-sidebar ${sidebarOpen ? "open" : ""}`}>
        ...
        <button className="emergency-help">
          <span><img src="/alert_3329142.png" alt="" className="emoji" /></span>
          <div>
            <div>Emergency</div>
            <div>help</div>
          </div>
      ...
      <header className="admin-header">
        ...
        <div className="header-right">
          <div className="header-icon"><img src="/magnifying-glass_673035.png" alt="" className="emoji" /></div>
          <div className="header-icon"><img src="/bell_232008.png" alt="" className="emoji" /></div>
          <div className="header-icon"><img src="/setting_653268.png" alt="" className="emoji" /></div>
          ...
          <>
            ...
            <div className="bottom-section">
              ...
              <div className="doctor-card">
                ...
                <div className="doctor-avatar"><img src="/doctor_3467875.png" alt="" className="emoji" /></div>
