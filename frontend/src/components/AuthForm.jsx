...
//  useEffect(() => {
//     // Only activate speech if we are on the `/auth` route
//     if (location.pathname !== "/auth") {
//       window.speechSynthesis.cancel(); // stop any speech if navigating away
//       return;
//     }
...
//       interval = setInterval(speakMessage, 15000);
...
//   }, [location.pathname, language]);
  ...
  useEffect(() => {
    ...
    if (location.pathname != "/auth"){ 
      ...
      speakMessage();
      const interval = setInterval(speakMessage, 45000);
