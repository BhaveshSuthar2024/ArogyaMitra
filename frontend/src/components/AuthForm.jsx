  ...
  const navigate = useNavigate();
   ...
   useEffect(() => {
    ...
    // Start speaking every 15 seconds after interaction
      ...
      const interval = setInterval(speakMessage, 5000);
            ...
            <form className="auth-form" onSubmit={handleSignInStep1}>
              <div className="form-group">
                ...
                <input
                  ...
                  tabIndex={0}
                />
                {errors.mobile && <div className="error-message">⚠️ {errors.mobile}</div>}
              </div>
            ...
            <form className="auth-form" onSubmit={handleSignUpStep1}>
              ...
              <div className="form-row">
                ...
                <div className="form-group">
                  ...
                  {errors.dateOfBirth && <div className="error-message">⚠️ {errors.dateOfBirth}</div>}
                </div>
              </div>
