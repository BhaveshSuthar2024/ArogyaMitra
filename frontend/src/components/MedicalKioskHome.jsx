      ...
      <div className="container">
        ...
        <div className="header">
          <div className="header-left">
            <div className="header-icon"><img src="/stethoscope_2002576.png" alt="" className="emoji" /></div>
            <div>
          ...
          <div className="header-right">
            ...
            <button className="language-switcher" onClick={toggleLanguage} title={t("language.switch")}>
              <span className="language-icon"><img src="/globe_12925125.png" alt="" className="emoji" /></span>
              ...
              <div className="time-display">
                <span><img src="/clock_3571703.png" alt="" className="emoji" /></span>
                <span>{currentTime}</span>
              </div>
              <div className={`location-display ${language === "hi" ? "hindi-text" : ""}`}>
                <span><img src="/lollipop_1824314.png" alt="" className="emoji" /></span>
        ...
        <div className="emergency-alert">
          <span className="emergency-icon"><img src="/warning_13898912.png" alt="" className="emoji" /></span>
          ...
          <button className={`emergency-button ${language === "hi" ? "hindi-text" : ""}`}>
            <span><img src="/telephone_1840922.png" alt="" className="emoji" /></span>
            {t("emergency.button")}
          </button>
        </div>
