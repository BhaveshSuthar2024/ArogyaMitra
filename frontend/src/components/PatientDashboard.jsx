  ...
  const navigationItems = [
    {
      ...
      items: [
        { id: "dashboard", label: t("nav.dashboard"), icon: "/house_561263.png", badge: null },
        { id: "health", label: t("nav.health.summary"), icon: "/love_2545869.png", badge: null },
        { id: "history", label: t("nav.medical.history"), icon: "/note_4371132.png", badge: null },
        { id: "prescriptions", label: t("nav.prescriptions"), icon: "/capsule_2008183.png", badge: 2 },
        { id: "scanner", label: t("nav.health.scanner"), icon: "/microscope_1940643.png", badge: null },
      ],
    },
    {
      ...
      items: [
        { id: "appointments", label: t("nav.appointments"), icon: "/schedule_3174027.png", badge: 1 },
        { id: "consultation", label: t("nav.video.consultation"), icon: "/video-camera_726295.png", badge: null },
      ],
    },
    {
      section: "documents",
      ...
      items: [
        { id: "reports", label: t("nav.reports"), icon: "/analytics_2030158.png", badge: null },
        {
          id: "notifications",
          label: t("nav.notifications"),
          icon: "/bell_232008.png",
    ...
    },
    {
      ...
      items: [
        { id: "profile", label: t("nav.profile.settings"), icon: "/setting_653268.png", badge: null },
        { id: "emergency", label: t("nav.emergency.contacts"), icon: "/sos_595031.png", badge: null },
      ],
    },
  ]
  ...
  const renderWelcomePanel = () => (
    <>
      <div style={{ marginBottom: "20px", display: "flex", alignItems: "center" }}>
        ...
        >
          <img src="/logout_14723873.png" alt="" className="emoji" /> {t("btn.sign.out")}
        </button>
      ...
      <div className="health-card">
        <div className="health-card-header">
          <div className="health-card-icon vitals">
            <img src="/heart_4252630.png" alt="" className="emoji" />
          </div>
      ...
      <div className="health-card">
        <div className="health-card-header">
          <div className="health-card-icon diagnosis">
            <img src="/robot_3181656.png" alt="" className="emoji" />
          </div>
      ...
      <div className="health-card">
        <div className="health-card-header">
          <div className="health-card-icon conditions">
            <img src="/global-aid_13179322.png" alt="" className="emoji" />
          </div>
                  ...
                  <div key={index} className="history-item">
                    ...
                    <div className="history-actions">
                      <button className="btn btn-small btn-secondary">
                        <img src="/note_4371132.png" alt="" className="emoji" /> View Report
                      </button>
                      <button className="btn btn-small btn-secondary">
                        <img src="/capsule_2008183.png" alt="" className="emoji" /> Prescriptions
                      </button>
                      <button className={`btn btn-small btn-primary ${language === "hi" ? "hindi-text" : ""}`}>
                        <img src="/share_16786846.png" alt="" className="emoji" /> {t("btn.share")}
                      </button>
                    </div>
                  </div>
                ))}
                ...
                {patientData.prescriptions.map((prescription) => (
                  <div key={prescription.id} className="prescription-card">
                    ...
                    <div className="prescription-actions">
                      <button className="btn btn-small btn-secondary">
                        <img src="/bell_232008.png" alt="" className="emoji" /> Remind
                      </button>
                      <button className="btn btn-small btn-primary">
                        <img src="/reload_17926872.png" alt="" className="emoji" /> Refill
                      </button>
                    </div>
                  </div>
                ))}
                    ...
                    <div className="appointment-actions">
                      {appointment.status === "scheduled" && (
                        <>
                          <button className="btn btn-small btn-success">
                            <img src="/video-camera_726295.png" alt="" className="emoji" /> Join Video
                          </button>
                          <button className="btn btn-small btn-secondary">
                            <img src="/note_4371132.png" alt="" className="emoji" /> Reschedule
                          </button>
                          <button className="btn btn-small btn-secondary ">
                            <img src="/close_143604.png" alt="" className="emoji" /> Cancel
                          </button>
                        </>
                      )}
                      {appointment.status === "completed" && (
                        <>
                          ...
                          <button className="btn btn-small btn-primary">
                            <img src="/reload_17926872.png" alt="" className="emoji" /> Book Follow-up
                          </button>
                        </>
                      )}
                    </div>
          ...
          <>
            ...
            <div className="video-consultation">
              <h2 className={`video-title ${language === "hi" ? "hindi-text" : ""}`}>
                <img src="/video-camera_726295.png" alt="" className="emoji" /> {t("nav.video.consultation")}
              </h2>
              <p className="video-description">Connect with healthcare professionals from the comfort of your home</p>
              <div className="video-actions">
                <button className="video-btn">
                  <img src="/video-camera_726295.png" alt="" className="emoji" /> Start Consultation
                </button>
                <button className="video-btn">
                  <img src="/pencil_202502.png" alt="" className="emoji" /> Pre-Consult Form
                </button>
                <button className="video-btn">
                  <img src="/message_5320666.png" alt="" className="emoji" /> Chat Support
                </button>
              </div>
            </div>
            <div className="content-section">
              ...
              <div className="appointments-grid">
                <div className="appointment-card">
                  ...
                  <div className="appointment-actions">
                    <button className="btn btn-small btn-success">
                      <img src="/video-camera_726295.png" alt="" className="emoji" /> Connect Now
                    </button>
                    <button className="btn btn-small btn-primary">
                      <img src="/schedule_3174027.png" alt="" className="emoji" /> Schedule
                    </button>
                  </div>
                </div>
              </div>
              ...
              <div className="section-header">
                ...
                <div className="section-actions">
                  <button className="btn btn-secondary">
                    <img src="/share_16786846.png" alt="" className="emoji" /> Upload
                  </button>
                  <button className="btn btn-primary">
                    <img src="/folder_3767094.png" alt="" className="emoji" /> Organize
                  </button>
                </div>
              </div>
                ...
                {patientData.documents.map((document) => (
                  <div key={document.id} className="document-card" onClick={() => openModal(document)}>
                    ...
                    <div className="document-actions">
                      <button className="btn btn-small btn-secondary">
                        <img src="/eye_2574244.png" alt="" className="emoji" /> View
                      </button>
                      <button className="btn btn-small btn-primary">
                        <img src="/share_16786846.png" alt="" className="emoji" /> Download
                      </button>
                    </div>
                  </div>
                ))}
          ...
          <>
            ...
            <div className="content-section">
              <div className="section-header">
                ...
                <div className="section-actions">
                  <button className="btn btn-secondary">
                    <img src="/check-box_12503615.png" alt="" className="emoji" /> Mark All Read
                  </button>
                  <button className="btn btn-primary">
                    <img src="/setting_653268.png" alt="" className="emoji" /> Settings
                  </button>
                </div>
              </div>
          ...
          <>
            ...
            <div className="content-section">
              <div className="section-header">
                ...
                <div className="section-actions">
                  <button className="btn btn-secondary">
                    <img src="/reload_17926872.png" alt="" className="emoji" /> Reset
                  </button>
                  <button className="btn btn-primary">
                    <img src="/floppy-disk_2011797.png" alt="" className="emoji" /> Save Changes
                  </button>
                </div>
              </div>
              <div className="settings-grid">
                <div className="settings-card">
                  ...
                  <div className="form-group">
                    ...
                    <input type="text" className="form-input" placeholder={patientData.name} />
                  </div>
                  <div className="form-group">
                    <label className="form-label">Email</label>
                    <input type="email" className="form-input" placeholder={patientData.email} />
                  </div>
                  <div className="form-group">
                    <label className="form-label">Phone</label>
                    <input type="tel" className="form-input" placeholder={patientData.phone} />
                  </div>
                </div>
                ...
                <div className="settings-card">
                  ...
                  <div className="form-group">
                    ...
                    <input type="text" className="form-input" placeholder={patientData.aadhaar} />
                    <div className="verification-status">
                      <span className="status-badge verified">
                        <img src="/check-box_12503615.png" alt="" className="emoji" /> Verified
                      </span>
                    </div>
                  </div>
                  <div className="form-group">
                    <label className="form-label">Blood Group</label>
                    <input type="text" className="form-input" placeholder-={patientData.bloodGroup} />
                  </div>
                </div>
            ...
            <div className="content-section">
              <div className="section-header">
                ...
                <div className="section-actions">
                  ...
                  <button className="btn btn-primary">
                    <img src="/add_2377877.png" alt="" className="emoji" /> Add Contact
                  </button>
                </div>
              </div>
                ...
                {patientData.emergencyContacts.map((contact) => (
                  <div key={contact.id} className="contact-item">
                    ...
                    <div className="contact-actions">
                      <button className="btn btn-small btn-success">
                        <img src="/telephone_1840922.png" alt="" className="emoji" /> Call
                      </button>
                      <button className="btn btn-small btn-secondary">
                        <img src="/pencil_202502.png" alt="" className="emoji" /> Edit
                      </button>
                    </div>
                  </div>
                ))}
