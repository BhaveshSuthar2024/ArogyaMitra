  ...
  const mockDoctors = [
    {
      ...
      location: "Mumbai",
      status: "pending",
      profilePicture: "/woman_5732666.png",
    ...
    },
    {
      ...
      location: "Delhi",
      status: "verified",
      profilePicture: "/man_11696179.png",
    ...
    <div className="doctor-management">
      ...
      <div className="page-header">
        <div className="header-left">
          ...
          <h1 className="page-title">
            <img src="/doctor_2008176.png" alt="" className="emoji" />
            Doctor Management
          </h1>
        </div>
      ...
      <div className="filters-section">
        <div className="search-bar">
          ...
          />
          <img src="/search_2811806.png" alt="" className="search-icon" />
        </div>
                ...
                <td>
                  <div className="actions-cell">
                    <button
                      ...
                      title="View Profile"
                    >
                      <img src="/eye_2574244.png" alt="" className="action-icon" />
                    </button>
                    ...
                    {doctor.status === "pending" && (
                      <>
                        <button
                          ...
                          title="Verify Doctor"
                        >
                          <img src="/check-box_12503615.png" alt="" className="action-icon" />
                        </button>
                        <button
                          ...
                          title="Reject Doctor"
                        >
                          <img src="/close_143604.png" alt="" className="action-icon" />
                        </button>
                      </>
                    )}
                    ...
                    >
                      <img
                        src={doctor.isActive ? "/pause_2404385.png" : "/play_2404388.png"}
                        alt=""
                    ...
                    <button
                      ...
                      title="Delete Doctor"
                    >
                      <img src="/delete_6861362.png" alt="" className="action-icon" />
                    </button>
                  </div>
                </td>
              </tr>
                  ...
                  <div className="detail-section">
                    ...
                    <div className="documents-list">
                      <div className="document-item">
                        <img src="/note_4371132.png" alt="" className="document-icon" />
