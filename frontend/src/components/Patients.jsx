      ...
      <div className="patients-header">
        ...
        <div className="patients-actions">
          <button className="export-btn" onClick={handleExport}>
            <img src="/export_6203207.png" alt="" className="emoji" /> Export
          </button>
        ...
        <div className="patients-list">
          {currentPatients.map((patient) => (
            <div key={patient.id} className="patient-item" onClick={() => handlePatientClick(patient)}>
              <div className="patient-avatar"><img src={patient.avatar} alt="" className="emoji_patient" /></div>
              <div className="patient-info">
                ...
                <div className="patient-actions">
                  <button className="action-btn primary" title="View Details">
                    <img src="/eye_2574244.png" alt="" className="emoji" />
                  </button>
                  <button className="action-btn" title="Edit">
                    <img src="/pencil_202502.png" alt="" className="emoji" />
                  </button>
