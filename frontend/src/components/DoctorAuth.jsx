...
const DoctorAuth = ({ onAuthSuccess }) => {
  ...
  const BASE_URL = "https://arogyamitra-asdf.onrender.com";
    ...
    switch (currentSignUpStep) {
      ...
      case 2:
        if (
          ...
          signUpData.qualifications.length === 0 || 
          signUpData.experience === "" ||          
          isNaN(signUpData.experience) ||           
        ...
        <div className="doctor-auth-card">
          <div className="auth-header">
            <div className="auth-logo">
              <div className="logo-icon"><img src="/hospital_1392165.png" alt="" className="emoji" /></div>
              <h1>Doctor Portal</h1>
            </div>
          </div>
          ...
          <div className="auth-step">
            ...
            {error && (
              <div className="error-message">
                <span className="error-icon"><img src="/warning_13898912.png" alt="" className="emoji" /></span>
                {error}
              </div>
            )}
            ...
            <form onSubmit={(e) => { e.preventDefault(), handleSignUpSubmit()}}>
              ...
              <button type="submit" className="auth-btn primary" disabled={loading || otp.length !== 6}>
                {loading ? (
                  <>
                    <span className="loading-spinner"><img src="/hourglass_5168222.png" alt="" className="emoji" /></span>
                    Verifying...
                  </>
                ) : (
                  "Verify & Sign In"
              ...
              <div className="signup-step">
                    ...
                    {["Male", "Female", "Other"].map((gender) => (
                      <div key={gender} className="radio-option">
                        ...
                        <label htmlFor={`gender-${gender}`} className="radio-label">
                          {gender === "Male" ? <img src="/man_11696179.png" alt="" className="emoji" /> : gender === "Female" ? <img src="/woman_5732666.png" alt="" className="emoji" /> : <img src="/toppng.com-icons-logos-emojis-user-icon-png-transparent-2400x2305.png" alt="" className="emoji" />}
                          {gender}
                        </label>
                      </div>
                    ))}
                ...
                <div className="form-group">
                  ...
                  <div className="file-upload-area">
                    ...
                    >
                      <img src="/video-camera_726295.png" alt="" className="emoji" /> Upload Profile Photo
                    </button>
              ...
              <div className="signup-step">
                ...
                <div className="form-group">
                  ...
                  <div className="file-upload-area">
                    ...
                    >
                      <img src="/id-card_529593.png" alt="" className="emoji" /> Upload License Certificate
                    </button>
                ...
                <div className="form-group">
                  ...
                  <div className="file-upload-area">
                    ...
                    >
                      <img src="/id-card_529593.png" alt="" className="emoji" /> Upload ID Proof
                    </button>
