          ...
          <div className="auth-step">
            ...
            {error && (
              <div className="error-message">
                <span className="error-icon"><img src="public/warning_13898912.png" alt="" className="emoji" /></span>
                {error}
              </div>
            )}
            ...
            <form onSubmit={(e) => { e.preventDefault(), handleSignUpSubmit()}}>
              ...
              <button type="submit" className="auth-btn primary" disabled={loading || otp.length !== 6}>
                {loading ? (
                  <>
                    <span className="loading-spinner"><img src="public/hourglass_5168222.png" alt="" className="emoji" /></span>
                    Verifying...
                  </>
                ) : (
                  "Verify & Sign In"
              ...
              <div className="signup-step">
                    ...
                    {["Male", "Female", "Other"].map((gender) => (
                      <div key={gender} className="radio-option">
                        ...
                        <label htmlFor={`gender-${gender}`} className="radio-label">
                          {gender === "Male" ? <img src="public/man_11696179.png" alt="" className="emoji" /> : gender === "Female" ? <img src="public/woman_5732666.png" alt="" className="emoji" /> : <img src="public/toppng.com-icons-logos-emojis-user-icon-png-transparent-2400x2305.png" alt="" className="emoji" />}
                          {gender}
                        </label>
                      </div>
                    ))}
                ...
                <div className="form-group">
                  ...
                  <div className="file-upload-area">
                    ...
                    >
                      <img src="public/video-camera_726295.png" alt="" className="emoji" /> Upload Profile Photo
                    </button>
              ...
              <div className="signup-step">
                ...
                <div className="form-group">
                  ...
                  <div className="file-upload-area">
                    ...
                    >
                      <img src="public/id-card_529593.png" alt="" className="emoji" /> Upload License Certificate
                    </button>
                ...
                <div className="form-group">
                  ...
                  <div className="file-upload-area">
                    ...
                    >
                      <img src="public/id-card_529593.png" alt="" className="emoji" /> Upload ID Proof
                    </button>
