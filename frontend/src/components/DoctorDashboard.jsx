...
const socket = io("https://arogyamitra-asdf.onrender.com"); // Match backend
...
const handleReject = async (requestId) => {
  ...
  const navigationItems = [
    { id: "dashboard", icon: "/house_561263.png", label: "Dashboard" },
    { id: "profile", icon: "/toppng.com-icons-logos-emojis-user-icon-png-transparent-2400x2305.png", label: "Profile" },
    { id: "requests", icon: "/note_4371132.png", label: "Requests" },
    { id: "appointments", icon: "/schedule_3174027.png", label: "Appointments" },
    { id: "patients", icon: "/couple_547629.png", label: "Patients" },
    { id: "consultation", icon: "/thermometer_1400304.png", label: "Consultation" },
    { id: "messages", icon: "/export_6203207.png", label: "Messages" },
    { id: "reports", icon: "/bar_14968536.png", label: "Reports" },
    { id: "settings", icon: "/setting_653268.png", label: "Settings" },
  ]
      ...
      <div className="stats-section">
        <div className="stats-card">
          <div className="stats-header">
            ...
            <div className="stats-icon patients"><img src="/couple_547629.png" alt="" className="emoji" /></div>
          </div>
          <h2 className="stats-number"></h2>
          <div className="stats-change positive">
            <span><img src="/bar_14968536.png" alt="" className="emoji" /></span>
        ...
        <div className="stats-card">
          <div className="stats-header">
            ...
            <div className="stats-icon diagnoses">🩺</div> {/*  njnfsdjnkdsfnv */}
          </div>
        ...
        <div className="stats-card">
          <div className="stats-header">
            ...
            <div className="stats-icon appointments"><img src="/schedule_3174027.png" alt="" className="emoji" /></div>
          </div>
        ...
        <div className="stats-card">
          <div className="stats-header">
            ...
            <div className="stats-icon requests"><img src="/hourglass_5168222.png" alt="" className="emoji" /></div>
          </div>
          <h2 className="stats-number">{pendingRequests?.length}</h2>
          <div className="stats-change negative">
            <span><img src="/decrease_12813655.png" alt="" className="emoji" /></span> 
          ...
          {selectedPatient && (
            <div className="consultation-panel">
              ...
              <div className="symptoms-section">
                ...
                <div className="symptoms-grid">
                  <div className="symptom-item">
                    <div className="symptom-icon"><img src="/sick_1094379.png" alt="" className="emoji" /></div>
                    <div className="symptom-label">Fever</div>
                  </div>
                  <div className="symptom-item">
                    <div className="symptom-icon"><img src="/dissapointment_3922870.png" alt="" className="emoji" /></div>
                    <div className="symptom-label">Cough</div>
                  </div>
                  <div className="symptom-item">
                    <div className="symptom-icon"><img src="/love_2545869.png" alt="" className="emoji" /></div>
              ...
              <div className="action-buttons">
                <button className="btn btn-primary"><img src="/note_4371132.png" alt="" className="emoji" /> Diagnose</button>
                <button className="btn btn-secondary"><img src="/analytics_2030158.png" alt="" className="emoji" /> History</button>
              </div>
            </div>
          )}
        </div>
        ...
        return (
          <div className="content-section">
            <div className="section-header">
              ...
              <div>
                <button className="btn btn-secondary"><img src="/share_16786846.png" alt="" className="emoji" /> Export</button>
                <button className="btn btn-primary"><img src="/floppy-disk_2011797.png" alt="" className="emoji" /> Save Changes</button>
              </div>
            </div>
              ...
              {pendingRequests?.map((request) => (
                <tr key={request.requestId} className="request-row">
                  ...
                  <td className="request-actions">
                    ...
                    >
                      <img src="/check-box_12503615.png" alt="" className="emoji" /> Accept
                    </button>
                    <button
                      className="btn btn-danger btn-small"
                      onClick={() => handleReject(request._id)}
                    >
                      <img src="/close_143604.png" alt="" className="emoji" /> Reject
                    </button>
                  </td>
                </tr>
              ))}
        ...
        return (
          <div className="content-section">
            <div className="section-header">
              ...
              <div>
                <button className="btn btn-secondary"><img src="/schedule_3174027.png" alt="" className="emoji" /> Calendar View</button>
                <button className="btn btn-primary"><img src="/add_2377877.png" alt="" className="emoji" /> New Appointment</button>                                     {/*ehhhfkjrkgnlkweaklgmkla*/}
              </div>
            </div>
            <table className="data-table">
              <thead>
              ...
              <tbody>
                {dashboardData?.appointments.map((appointment) => (
                  <tr key={appointment.id}>
                    ...
                    <td>
                      <button className="btn btn-primary btn-small"><img src="/video-camera_726295.png" alt="" className="emoji" /> Join</button>
                      <button className="btn btn-secondary btn-small"><img src="/note_4371132.png" alt="" className="emoji" /> Edit</button>
                    </td>
                  </tr>
                ))}
              </tbody>
        ...
        return (
          <div className="content-section">
            <div className="section-header">
              ...
              <div>
                <button className="btn btn-secondary"><img src="/bar_14968536.png" alt="" className="emoji" /> Analytics</button>
                <button className="btn btn-primary"><img src="/share_16786846.png" alt="" className="emoji" /> Export</button>
              </div>
            </div>
            <table className="data-table">
              <thead>
              ...
              <tbody>
                {dashboardData?.patientsDiagnosed.map((patient) => (
                  <tr key={patient.id}>
                    ...
                    <td>
                      <button className="btn btn-primary btn-small"><img src="/eye_2574244.png" alt="" className="emoji" /> View</button>
                      <button className="btn btn-secondary btn-small"><img src="/note_4371132.png" alt="" className="emoji" /> Notes</button>
                    </td>
                  </tr>
                ))}
              </tbody>
        ...
        return (
          <div className="content-section">
            <div className="section-header">
              ...
              <div>
                <button className="btn btn-secondary"><img src="/clock_3571703.png" alt="" className="emoji" /> Patient History</button>
                <button className="btn btn-primary"><img src="/check-box_12503615.png" alt="" className="emoji" /> Save Diagnosis</button>
              </div>
            </div>
            {selectedPatient ? (
              <>
                ...
                <div className="ai-suggestion">
                  <div className="ai-suggestion-header">
                    <span className="ai-icon"><img src="/robot_3181656.png" alt="" className="emoji" /></span>                              {/*kmlfdddddkmlmsfdklmlkmz*/}
                  ...
                  <div className="ai-actions">
                    <button className="ai-btn accept"><img src="/check-box_12503615.png" alt="" className="emoji" /> Accept</button>
                    <button className="ai-btn modify"><img src="/pencil_202502.png" alt="" className="emoji" /> Modify</button>
                    <button className="ai-btn reject"><img src="/close_143604.png" alt="" className="emoji" /> Reject</button>
                  </div>
                </div>
                ...
                <div className="action-buttons">
                  <button className="btn btn-success"><img src="/check-box_12503615.png" alt="" className="emoji" /> Complete Consultation</button>
                  <button className="btn btn-secondary"><img src="/clock_3571703.png" alt="" className="emoji" /> Add to History</button>
                  <button className="btn btn-primary"><img src="/schedule_3174027.png" alt="" className="emoji" /> Schedule Follow-up</button>
                </div>
              </>
            ) : (
        ...
        return (
          <div className="content-section">
            <div className="section-header">
              ...
              <div>
                <button className="btn btn-secondary"><img src="/check-box_12503615.png" alt="" className="emoji" /> Mark All Read</button>
                <button className="btn btn-primary"><img src="/check-box_12503615.png" alt="" className="emoji" /> New Message</button>
              </div>
            </div>
            <div style={{ textAlign: "center", padding: "60px", color: "#64748b" }}>
              <h3><img src="/message_5320666.png" alt="" className="emoji" /> Messages</h3>
        ...
        return (
          <div className="content-section">
            <div className="section-header">
              ...
              <div>
                <button className="btn btn-secondary"><img src="/magnifying-glass_673035.png" alt="" className="emoji" /> Search</button>
                <button className="btn btn-primary"><img src="/analytics_2030158.png" alt="" className="emoji" /> Generate Report</button>
              </div>
            </div>
            <div style={{ textAlign: "center", padding: "60px", color: "#64748b" }}>
              <h3><img src="/analytics_2030158.png" alt="" className="emoji" /> Reports & Analytics</h3>
        ...
        return (
          <div className="content-section">
            <div className="section-header">
              ...
              <div>
                <button className="btn btn-secondary"><img src="/reload_17926872.png" alt="" className="emoji" /></button>
                <button className="btn btn-primary"><img src="/check-box_12503615.png" alt="" className="emoji" /> Save Settings</button>
              </div>
            </div>
            <div className="form-grid">
              <div className="form-group">
            ...
            <div style={{ marginTop: "40px", padding: "20px", background: "#f8fafc", borderRadius: "12px" }}>
              <h3><img src="/letter-i_9867076.png" alt="" className="emoji" /> Support & Help</h3>
              <p>Need assistance? Contact our support team</p>
              <div className="action-buttons">
                <button className="btn btn-secondary"><img src="/telephone_1840922.png" alt="" className="emoji" /> Call Support</button>
                <button className="btn btn-primary"><img src="/message_5320666.png" alt="" className="emoji" /> Chat Support</button>                {/*ndvkjsaanvkamwsklMcklmdlmlk*/}
                <button className="btn btn-secondary"><img src="/toppng.com-icons-logos-emojis-user-icon-png-transparent-2400x2305.png" alt="" className="emoji" /> User Manual</button>
              </div>
            </div>
          </div>
        )
  ...
  return (
    <div className="doctor-dashboard-container">
      ...
      <aside className="doctor-sidebar">
        <div className="sidebar-logo"><img src="/hospital_1392165.png" alt="" className="emoji_side" /></div>
      ...
      <main className="doctor-main">
        ...
        <div className="doctor-header">
          <div className="search-container">
            ...
            <span className="search-icon"><img src="/magnifying-glass_673035.png" alt="" className="emoji" /></span>
          </div>
          <div className="header-actions">
            <div className="header-icon"><img src="/doctor_3467875.png" alt="" className="emoji_side" /></div>
            <div className="header-icon"><img src="/bell_232008.png" alt="" className="emoji_side" /></div>
